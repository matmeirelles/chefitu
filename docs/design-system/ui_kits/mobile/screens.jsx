...
const MACARRAO_THUMB = IMG_BASE + 'food-macarrao-thumb.png';
const FRANGO = IMG_BASE + 'food-frango.png';
const PANQUECA = IMG_BASE + 'food-panqueca.png';
const SOPA = IMG_BASE + 'food-sopa.png';
const MASCOT = IMG_BASE + 'mascot-symbol.png';
const COOKING = IMG_BASE + 'sticker-mascot-cooking.png';
const SPAGHETTI = IMG_BASE + 'sticker-spaghetti.png';
