...
### Changed
- Shopping list (CHE-36): aligned to lista handoff — add bar with **+** and **→**, card with counter and emoji rows, check-to-remove (no Comprados section), empty state in card, recipe ingredient rows with icon and **+** only
...
### Added
- Profile screen (CHE-18): editable avatar, name, and email (defaults Mateus / mat.meirelles1991@gmail.com), PT/EN interface language, help row, log-out stub via reusable `InConstructionBottomSheet`, and static app version under “Sobre o Chefitu”
