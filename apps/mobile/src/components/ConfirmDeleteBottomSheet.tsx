...
export const ConfirmDeleteBottomSheet = ({
  visible,
  recipeTitle,
  deleting,
  onConfirm,
    ...
    <Modal visible={visible} transparent animationType="none" onRequestClose={onCancel}>
      <View style={StyleSheet.absoluteFill} pointerEvents="box-none">
        <Animated.View style={[styles.backdrop, { opacity: fadeAnim }]} pointerEvents="auto">
          <Pressable style={StyleSheet.absoluteFill} onPress={onCancel} disabled={deleting} />
        </Animated.View>
        ...
        >
          {/* Card principal: título + mensagem + botão excluir */}
          <View style={styles.mainCard}>
            <DSText style={styles.title}>Excluir "{recipeTitle}"?</DSText>
            <DSText style={styles.body}>
              A receita será removida das suas salvas. Essa ação não pode ser desfeita.
            </DSText>
            ...
            >
              ...
              <DSText style={styles.deleteLabel}>
                {deleting ? "Excluindo receita…" : "Excluir receita"}
              </DSText>
            </Pressable>
          </View>

          {/* Card separado: cancelar */}
          <Pressable
            style={({ pressed }) => [styles.cancelCard, pressed && !deleting && styles.cancelCardPressed]}
            onPress={onCancel}
            disabled={deleting}
          >
            <DSText style={styles.cancelLabel}>Cancelar</DSText>
          </Pressable>
        </Animated.View>
      </View>
    </Modal>
